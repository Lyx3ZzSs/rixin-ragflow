...
class ParserParam(ProcessParamBase):
    def __init__(self):
        ...
        self.setups = {
            "pdf": {
                "parse_method": "PaddleOCR",  # PaddleOCR/plain_text/mineru/docling/opendataloader/tcadp_parser/vlm
                "lang": "Chinese",
...
class Parser(ProcessBase):
    ...
    def _pdf(self, name, blob, **kwargs):
        ...
        parse_method = parse_method or "PaddleOCR"
        if isinstance(raw_parse_method, str):
            raw_parse_method = raw_parse_method.strip()
