...
from common.paddleocr_config import resolve_paddleocr_runtime_config
...
class PaddleOCROcrModel(Base, PaddleOCRParser):
    ...
    def __init__(self, key: str | dict, model_name: str, **kwargs):
        ...
        resolved_config = resolve_paddleocr_runtime_config(config)
        self.paddleocr_api_url = resolved_config["PADDLEOCR_API_URL"]
        self.paddleocr_algorithm = resolved_config["PADDLEOCR_ALGORITHM"]
        self.paddleocr_access_token = resolved_config["PADDLEOCR_ACCESS_TOKEN"]
        self.paddleocr_request_timeout = int(resolved_config["PADDLEOCR_REQUEST_TIMEOUT"])
        self.paddleocr_poll_interval = int(resolved_config["PADDLEOCR_POLL_INTERVAL"])
        self.paddleocr_optional_payload = resolved_config["PADDLEOCR_OPTIONAL_PAYLOAD"]
        ...
        PaddleOCRParser.__init__(
            ...
            poll_interval=self.paddleocr_poll_interval,
        )
    ...
    def parse_pdf(self, filepath: str, binary=None, callback=None, parse_method: str = "raw", **kwargs):
        ...
        if self.paddleocr_optional_payload:
            additional_params = dict(kwargs.get("additional_params") or {})
            additional_params.setdefault("optionalPayload", self.paddleocr_optional_payload)
